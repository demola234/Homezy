...
class Config {
  ...
  static TextStyle h1(BuildContext context) => GoogleFonts.urbanist(
        fontSize: textSize(context, 4),
        height: 1.6,
        fontWeight: FontWeight.w600,
      );

  static TextStyle h2(BuildContext context) => GoogleFonts.urbanist(
        fontSize: textSize(context, 3),
        height: 1.6,
        fontWeight: FontWeight.w700,
      );

  static TextStyle h3(BuildContext context) => GoogleFonts.urbanist(
        fontSize: textSize(context, 2.5),
        height: 1.6,
        fontWeight: FontWeight.w400,
      );

  static TextStyle b1(BuildContext context) => GoogleFonts.urbanist(
        fontSize: textSize(context, 1.5),
        fontWeight: FontWeight.w600,
        height: 1.6,
      );

  static TextStyle b2(BuildContext context) => GoogleFonts.urbanist(
        fontSize: textSize(context, 1.5),
        fontWeight: FontWeight.w400,
        height: 1.6,
      );

  static TextStyle b3(BuildContext context) => GoogleFonts.urbanist(
